...
kubectl delete -f deploy/kubernetes/worker/worker-deployment.yaml || true
...
kubectl delete -f deploy/kubernetes/api/api-service.yaml || true
kubectl delete -f deploy/kubernetes/api/api-deployment.yaml || true
